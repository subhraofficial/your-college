...
// Fix MongoDB Atlas DNS/SRV resolution on some networks
...
// ========================================
//
// Bing/IndexNow checks:
// https://yourcollege.in/YOUR_KEY.txt
//
// The actual key comes from backend/.env
// ========================================
app.get("/:indexNowKey.txt", (req, res, next) => {
  ...
  if (req.params.indexNowKey !== configuredKey) {
    return next();
  }
